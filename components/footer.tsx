    ...
    <footer className="bg-zinc-900 border-t border-zinc-800 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-zinc-400 hover:text-amber-500 transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/theoxroom" className="text-zinc-400 hover:text-amber-500 transition-colors duration-200">
                  Início
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link
                  href="https://livemenu.app/menu/5bfeb704fa271c9ee3c5ee51"
                  className="text-zinc-400 hover:text-amber-500 transition-colors duration-200"
                >
                  Vinhos
                </Link>
              ...
              <li>
                <Link
                  href="https://delivery.lexsis.com.br/oxsteak/index/26"
                  className="text-zinc-400 hover:text-amber-500 transition-colors duration-200"
                >
                  Delivery
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-zinc-400">
              ...
              <li className="flex items-start">
                ...
                <span>contato@oxsteakhouse.com.br</span>
              </li>
            </ul>

            <div className="mt-6">
              <AnimatedButton className="bg-amber-600 hover:bg-amber-700 text-white rounded-full py-2 px-6 text-sm font-medium w-full">
                Reservar Mesa
              </AnimatedButton>
            </div>
          </div>
        ...
        <div className="border-t border-zinc-800 pt-8 text-center">
          <p className="text-zinc-500 text-sm">&copy; {currentYear} OX Steakhouse. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
