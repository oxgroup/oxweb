...
export default function OxSteakFish() {
  // Carousel content com imagens e vídeos da OX Steak & Fish
  const carouselContent = [
    {
      type: "image" as const,
      src: "/images/ox-interior.png",
      alt: "Interior elegante da OX Steak & Fish",
    ...
    },
    {
      ...
      alt: "Especialidades em peixes da OX Steak & Fish",
      caption: "Nossos pratos especiais de frutos do mar, preparados com técnicas exclusivas",
    },
    {
      type: "image" as const,
      src: "/images/ox-tomahawk.png",
      alt: "Tomahawk premium da OX Steak & Fish",
      caption: "Nosso emblemático corte Tomahawk, preparado com técnicas exclusivas",
    },
    {
      type: "image" as const,
      src: "/images/ox-drinks.png",
      alt: "Carta de drinks autorais da OX Steak & Fish",
      caption: "Drinks autorais que elevam sua experiência gastronômica",
    },
    {
      type: "image" as const,
      src: "/images/ox-wine-selection.png",
      alt: "Seleção de vinhos da OX Steak & Fish",
    ...
    },
    {
      ...
      alt: "Área lounge da OX Steak & Fish",
    ...
    <div className="relative bg-zinc-900 text-zinc-100 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div className="relative min-h-[80vh] mb-20 md:mb-32 overflow-hidden rounded-3xl">
          ...
          >
            <source src="http://www.oxsteakhouse.com.br/img/bcvideo.mov" type="video/mp4" />
          </video>
            ...
            <div className="max-w-3xl glass-effect p-8 md:p-12 rounded-2xl animate-float">
              <div className="mb-6">
                <h1 className="font-bold mb-6 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 bg-clip-text text-transparent">
                  Steak & Fish Experience
                </h1>
              </div>

              <p className="text-xl md:text-2xl mb-10 text-slate-200 leading-relaxed">
                A perfeita fusão entre os melhores cortes de carne e os mais frescos frutos do mar,
                criando uma experiência gastronômica única que celebra o melhor da terra e do mar.
              </p>
        ...
        <AnimatedSection delay={0.2} className="relative mb-20 md:mb-32 group">
         <div className="text-center mb-12">
             <h2 className="text-2xl md:text-4xl font-bold mb-4 text-amber-500">Experiência Steak & Fish</h2>
             <p className="text-lg text-zinc-300 max-w-3xl mx-auto">
          Descubra o sabor excepcional de nossos pratos, combinando os melhores cortes de carne com frutos do mar frescos,
          preparados com técnicas exclusivas para uma experiência gastronômica inigualável.
             </p>
         </div>
          ...
          <div className="relative overflow-hidden rounded-3xl p-12 md:p-16">
            ...
            <div className="relative z-10">
              ...
              <h2 className="font-bold mb-6 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 bg-clip-text text-transparent">
                Viva a Experiência OX Steak & Fish
              </h2>
              
              <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-12 leading-relaxed">
                Descubra por que a OX Steak & Fish se tornou um destino obrigatório para os amantes da boa gastronomia. 
                Faça sua reserva e prepare-se para uma jornada sensorial inesquecível onde terra e mar se encontram 
