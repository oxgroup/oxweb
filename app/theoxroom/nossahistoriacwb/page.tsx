    ...
    <div className="relative bg-zinc-900 text-zinc-100 min-h-screen">
      ...
      <div className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          >
            Uma jornada de excelência gastronômica que começou em 2017
          </motion.p>
        </div>
      </div>
        ...
        <AnimatedSection direction="up" className="mb-20">
          <div className="glass-effect rounded-3xl p-8 md:p-12">
            <p className="text-xl md:text-2xl text-slate-200 leading-relaxed mb-8">
              Desde 2017, no charmoso bairro do Batel em Curitiba, a <span className="text-amber-400 font-semibold">The OX Room Steakhouse</span> nasceu 
            ...
            <div className="mb-8 md:mb-0">
              ...
              <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
                <p>
                  ...
                  <span className="text-amber-400 font-semibold"> farm to table</span> no segmento de steakhouses brasileiras, 
                  garantindo que cada corte servido em nossa mesa tenha no máximo 90 dias do abate.
                </p>
                
                <p>
                  Esta filosofia nos permite oferecer carnes com frescor e sabor incomparáveis. Em nosso açougue central, 
                  realizamos toda a desossa do boi, um processo artesanal que nos permite selecionar apenas os melhores cortes.
                </p>
                
                <p>
                  Especializamo-nos em <span className="text-amber-400 font-semibold">cortes altos</span> – aquelas peças especiais 
                  que você não encontra em açougues convencionais, preparadas exclusivamente para o assador na brasa.
                </p>
              </div>
            </div>
            ...
            <div className="relative order-2 md:order-1 mb-8 md:mb-0">
              <div className="glass-effect rounded-2xl p-4">
                <AnimatedImage
                  ...
                  alt="Cortes premium Angus e Wagyu"
                  width={600}
                  height={400}
                  className="w-full rounded-xl object-cover"
                />
        ...
        <AnimatedSection direction="up" className="mb-20">
          <div className="glass-effect rounded-3xl p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
                <p>
                  A <span className="text-amber-400 font-semibold">The OX Room</span> foi pensada para ser o destino ideal tanto para 
                  jantares especiais quanto para almoços executivos de negócios.
                </p>
                
                <p>
                  Nosso <span className="text-amber-400 font-semibold">American Bar</span> oferece o ambiente perfeito para momentos 
                  agradáveis em boa companhia, seja para iniciar a noite ou encerrar uma reunião de negócios.
                </p>
        ...
        <AnimatedSection direction="up" className="text-center">
          <div className="glass-effect rounded-3xl p-8 md:p-12">
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-3xl mx-auto">
              ...
              Faça sua reserva e seja parte da nossa história.
            </p>
