      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <AnimatedImage
            ...
            alt="Fazenda parceira The OX Room"
            width={1920}
            height={1080}
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
          ...
          >
            Uma filosofia que conecta você diretamente com a origem dos ingredientes através de um processo artesanal 
        ...
        <AnimatedSection direction="up" className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Acompanhe cada etapa do processo que garante a qualidade excepcional dos nossos cortes
            </p>
          </div>
                ...
                <div className="md:grid md:grid-cols-2 md:gap-16 items-center">
                  <div className="glass-effect rounded-3xl p-8 md:p-12">
                    <div className="flex items-center mb-6">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold text-amber-400">Seleção da Fazenda</h3>
                    </div>
                    <p className="text-lg text-slate-300 leading-relaxed">
                      Escolhemos apenas fazendas que compartilham nossos valores de qualidade e sustentabilidade. 
                      Cada animal é criado com o cuidado necessário para desenvolver as características únicas que tornam nossa carne excepcional.
                    </p>
                  </div>
                  <div className="relative mt-8 md:mt-0">
                    <AnimatedImage
                      src="/images/ox-farm-cattle.png"
                      alt="Gado Angus na fazenda"
                      width={600}
                      height={400}
              ...
              <div className="relative">
                <div className="md:grid md:grid-cols-2 md:gap-16 items-center">
                  ...
                  <div className="glass-effect rounded-3xl p-8 md:p-12 order-1 md:order-2">
                    ...
                    <p className="text-lg text-slate-300 leading-relaxed">
                      Mantemos rastreabilidade completa desde a fazenda. Conhecemos a procedência de cada animal e 
                      garantimos que cada corte tenha no máximo 90 dias do abate, preservando frescor e qualidade incomparáveis.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="md:grid md:grid-cols-2 md:gap-16 items-center">
                  <div className="glass-effect rounded-3xl p-8 md:p-12">
                    <div className="flex items-center mb-6">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold text-amber-400">Açougue Central</h3>
                    </div>
                    <p className="text-lg text-slate-300 leading-relaxed">
                      Em nosso açougue central, realizamos toda a desossa do Angus e Wagyu. Este processo artesanal nos permite 
                      padronizar qualidade, maciez, sabor e tamanho de cada corte com precisão incomparável.
                    </p>
                  </div>
                  <div className="relative mt-8 md:mt-0">
                    <AnimatedImage
                      src="/images/ox-butcher-work.png"
                      alt="Trabalho no açougue central"
                      width={600}
                      height={400}
                      className="w-full rounded-2xl object-cover"
                    />
              ...
              <div className="relative">
                <div className="md:grid md:grid-cols-2 md:gap-16 items-center">
                  ...
                  <div className="glass-effect rounded-3xl p-8 md:p-12 order-1 md:order-2">
                    ...
                    <p className="text-lg text-slate-300 leading-relaxed">
                      O resultado final é uma experiência gastronômica única que carrega consigo não apenas sabor excepcional, 
                      mas também a história, o cuidado e a paixão que envolveram sua criação.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="glass-effect rounded-3xl p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-slate-300">Garantia de frescor incomparável em cada corte servido</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300">Controle completo da origem até o seu prato</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300">Apenas Angus e Wagyu certificados</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300">Desossa especializada em açougue próprio</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300">Consistência em maciez, sabor e tamanho</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-slate-300">Conexão direta com a origem dos ingredientes</p>
              </div>
            </div>
          </div>
        </AnimatedSection>
          ...
          <div className="glass-effect rounded-3xl p-8 md:p-16 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <blockquote className="text-2xl md:text-3xl text-slate-200 leading-relaxed mb-8 italic">
                ...
                seja autêntica, transparente e incomparável."
              </blockquote>
        ...
        <AnimatedSection direction="up" className="text-center">
          <div className="glass-effect rounded-3xl p-8 md:p-12">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Descubra o sabor incomparável da verdadeira filosofia Farm to Table. 
              Cada garfada conta uma história de qualidade, cuidado e excelência.
            </p>
